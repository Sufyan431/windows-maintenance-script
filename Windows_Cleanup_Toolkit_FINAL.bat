...
choice /M "   Do you want to run this step"
if errorlevel 2 goto net_dns_restart
netsh int ip reset
echo   Done.
echo.

:net_dns_restart
echo   CMD 3 : Restart DNS Client Service
echo   Info  : This will restart the DNS Client service.
choice /M "   Do you want to run this step"
if errorlevel 2 goto net_ip_renew
net stop dnscache
net start dnscache
echo   Done.
echo.
